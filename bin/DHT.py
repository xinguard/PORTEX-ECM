...
if __name__ == "__main__":
    ...
    DHT_list = ['4', '18']
    argc = len(DHT_list)  # get number of command line arguments
    ...
    while True:
        try:
            ...
            LOG01 = str(time.time()) + "\tMQTT_F_0\tHTTP_F_0" + "\ttemperature_01:" + \
                str(temperature_01) + "\thumidity_01:" + \
                str(humidity_01) + "\n"
            print(LOG01)
            datafile.write(LOG01)
            LOG02 = str(time.time()) + "\tMQTT_F_0\tHTTP_F_0" + "\ttemperature_02:" + \
                str(temperature_02) + "\thumidity_02:" + \
                str(humidity_02) + "\n"
            print(LOG02)
            datafile.write(LOG02)
            datafile.close()
