...
BASE_DIR=/home/portex/portex_ecm.d/
...
get_pid() {
    if [ ${PRIVATE_CLOUD} = 0 ]; then
        ...
        if [ "x${_pid_p1}" = "x" ] && [ "x${_pid_p2}" = "x" ]; then
            echo "NA"
        else
